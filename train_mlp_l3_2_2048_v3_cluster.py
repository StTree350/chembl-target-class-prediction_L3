...
def assign_cluster_groups_to_splits(
        ...
        assignment_rows.append(
            {
                ...
                "n_classes_in_cluster": int(row["n_classes_in_cluster"]),
    ...
    return train_indices, validation_indices, test_indices, cluster_assignments
...
def make_cluster_splits(
    ...
    train_indices, validation_indices, test_indices, cluster_assignments = (
        assign_cluster_groups_to_splits(
    ...
    cluster_stats_export = cluster_groups.drop(
    ...
    return train_indices, validation_indices, test_indices, cluster_stats_export
...
def save_config(
    ...
    config = {
        ...
        "split": {
            "split_type": "chemical_cluster_split",
...
def main() -> None:
    ...
    print(f"Split type: chemical cluster split")
    ...
    train_indices, validation_indices, test_indices, cluster_stats = make_cluster_splits(
        x=x,
        y=y,
        n_classes=n_classes,
    )
